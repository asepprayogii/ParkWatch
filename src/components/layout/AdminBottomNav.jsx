...
export default function AdminBottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-slate-900 border-t border-slate-700 px-1">
      <div className="flex items-center justify-around h-16">
        ...
        {/* Logout */}
        <button onClick={handleLogout} className="flex flex-col items-center gap-1 px-2 py-1 rounded-xl text-red-400 hover:text-red-300 transition">
