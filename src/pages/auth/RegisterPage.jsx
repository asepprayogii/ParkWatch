    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
          <div className="mb-6">
            <h2 className="text-xl font-semibold text-slate-700">Daftar sebagai Pelapor</h2>
            <p className="text-sm text-slate-400 mt-1">
              Bergabung dan bantu jaga keamanan komunitasmu
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Input
              ...
              required
              rightElement={
                <button type="button" onClick={() => setShowConfirm(!showConfirm)} className="flex items-center">
        ...
        <p className="text-center text-xs text-slate-400 mt-6">
          ParkWatch © 2026 · TechSprint Web Development
        </p>
      </div>
    </div>
  )
